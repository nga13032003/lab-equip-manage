...
import { getAllPhieuDeXuatLuanChuyen } from "../../api/phieuLuanChuyen";
import { Link } from "react-router-dom";

const PheDuyetLCTable = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (record) => (
        <Space>
           <Button>
            <Link to={`/chi-tiet-phe-duyet-luan-chuyen/${record.maPhieuLC}`} className="action-link view">
                Xem Chi Tiết
            </Link>
            </Button>
        </Space>
...
export default PheDuyetLCTable;
