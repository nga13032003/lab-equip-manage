...
import './TimelinePhieuLuanChuyen.scss'; // Import SCSS styles
import { getLichSuPhieuLuanChuyen } from '../../api/phieuLuanChuyen';
...
const TimelinePhieuLuanChuyen = ({ maPhieuLC }) => {
  ...
  useEffect(() => {
    const fetchLichSu = async () => {
      try {
        const data = await getLichSuPhieuLuanChuyen(maPhieuLC); // Use the API function
...
export default TimelinePhieuLuanChuyen;
